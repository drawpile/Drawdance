                                      ...
                                      DP_AffectedIndirectAreas *aia)
{
    ...
    case DP_MSG_LAYER_DELETE: {
        ...
        // mark it as conflicting with all layers to me safe.
    ...
    case DP_MSG_KEY_FRAME_SET:
        return make_timeline(
            DP_msg_key_frame_set_track_id(DP_msg_key_frame_set_cast(msg)));
    ...
    case DP_MSG_KEY_FRAME_DELETE:
        return make_timeline(DP_msg_key_frame_delete_track_id(
            DP_msg_key_frame_delete_cast(msg)));
    case DP_MSG_UNDO:
        return make_user_attrs();
    default:
