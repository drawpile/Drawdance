...
DP_TransientTrack *DP_transient_track_new_init(void)
{
    DP_TransientTrack *tt = allocate_track(true, 0);
    tt->id = 0;
    tt->title = NULL;
    return tt;
}
...
void DP_transient_track_insert_transient_noinc(DP_TransientTrack *tt,
                                               int frame_index,
                                               DP_TransientKeyFrame *tkf,
                                               int index)
{
